...
minetest.register_alias_force("better_fauna:cat_toy", "pegasus:cat_toy")
...
minetest.register_alias_force("better_fauna:bucket_milk", "pegasus:bucket_milk")
minetest.register_alias_force("better_fauna:leather", "pegasus:leather")
minetest.register_alias_force("better_fauna:chicken_egg", "pegasus:chicken_egg")
minetest.register_alias_force("better_fauna:chicken_raw", "pegasus:poultry_raw")
minetest.register_alias_force("better_fauna:chicken_cooked", "pegasus:poultry_cooked")
minetest.register_alias_force("better_fauna:feather", "pegasus:feather")
minetest.register_alias_force("better_fauna:mutton_raw", "pegasus:mutton_raw")
minetest.register_alias_force("better_fauna:mutton_cooked", "pegasus:mutton_cooked")
minetest.register_alias_force("better_fauna:porkchop_raw", "pegasus:porkchop_raw")
minetest.register_alias_force("better_fauna:porkchop_cooked", "pegasus:porkchop_cooked")
minetest.register_alias_force("better_fauna:turkey_raw", "pegasus:poultry_raw")
minetest.register_alias_force("better_fauna:turkey_cooked", "pegasus:poultry_cooked")